...
/* avrc event handler */
static void handle_avrc_event(uint16_t event, void *p_param);
/* avrc tag handler */
static void handle_avrc_tag(uint16_t event, void *p_param);
...
void bt_app_rc_ct_cb(esp_avrc_ct_cb_event_t event, esp_avrc_ct_cb_param_t *param)
{
    ...
    case ESP_AVRC_CT_GET_RN_CAPABILITIES_RSP_EVT: {
        bt_app_work_dispatch(handle_avrc_event, event, param, sizeof(esp_avrc_ct_cb_param_t), NULL);
        break;
    }
    default:
...
void bt_app_rc_tg_cb(esp_avrc_tg_cb_event_t event, esp_avrc_tg_cb_param_t *param)
{
    ...
    case ESP_AVRC_TG_REGISTER_NOTIFICATION_EVT:
        bt_app_work_dispatch(handle_avrc_tag, event, param, sizeof(esp_avrc_tg_cb_param_t), NULL);
        break;
    default:
